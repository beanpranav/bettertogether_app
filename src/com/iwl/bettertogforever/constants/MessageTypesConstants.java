package com.iwl.bettertogforever.constants;

public final class MessageTypesConstants {
	...
	public static final String ADD_SPOUSE_ID_TAG = "add_spouse_id_tag";
	public static final String ADD_SPOUSE_CPL_ID_TAG = "add_spouse_cpl_id_tag";
	
	//secret message updated related tags
	public static final String SECRET_MSG_TAG = "secret_msg_tag";
